...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <style type="text/css">
            ...
            h2 {
                height: 37px; line-height:37px; border-bottom-color: #d6d6d6; border-bottom-width: 1px; border-bottom-style: solid; vertical-align: middle;
                margin: 0; margin-top: 20px; padding: 0;font-size: 16px; font-weight: bold; color: #fd2323; text-align: left;
            }
            p,blockquote{
                margin: 0; margin-top: 7px; margin-bottom: 20px; padding: 0; font-size: 13px; font-weight: normal; color: #535353; line-height: 22px; text-align: justify;
            }
            blockquote {
                font-style:italic;
            }
            p.notice{
                margin: 0; padding: 0; line-height: 14px; font-size: 11px; font-weight: bold; color: #8a8a8a; text-align: center;
            }
            li {
                font-size: 13px; font-weight: normal; color: #535353; line-height: 22px; text-align: justify;
            }
            a,strong {color:#fd2323;}
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td valign="top" style="text-align: left;">
                                                        <!-- heading + date -->
                                                        <h1 style="margin: 0; padding: 0; font-size: 22px; color: #fd2323; font-weight: bold;">[[*pagetitle]]</h1>
                                                        <p class="date" style="margin: 0; padding: 0; font-size: 14px; font-weight: bold; color: #bababa;">[[*publishedon:strtotime:date=`%B %d, %Y`]]</p>
                                                        <!-- Spacing -->
                                                ...
                                                <tr>
                                                    <td valign="middle" height="58" style="height: 58px; vertical-align: middle; border-top-color: #d6d6d6; border-top-width: 1px; border-top-style: solid;">
                                                        <p style="font-size: 11px; font-weight: bold; color: #8a8a8a; text-align: center;">
                                                            Don&rsquo;t want to receive these newsletters anymore? Manage your <a href="[[~42? &nwl=`[[+newsletterID]]` &s=`[[+subscriberID]]` &c=`[[+code]]` ]]" style="color: #fd2323; text-decoration: none;">email preferences here</a>, or <a href="[[~42? &nwl=`[[+newsletterID]]` &s=`[[+subscriberID]]` &c=`[[+code]]` ]]" style="color: #fd2323; text-decoration: none;">unsubscribe</a>. 
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
